...
"[project]/src/app/speech/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SpeechPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const SpeechRecognition = ("TURBOPACK compile-time value", "undefined") !== "undefined" && (window.SpeechRecognition || window.webkitSpeechRecognition);
    ...
    const start = ()=>{
        ...
        try {
            ...
            setError("Failed to start: " + (e?.message || String(e)));
        }
    };
    const stop = ()=>{
        if (!recognitionRef.current) return;
        try {
            ...
            setError("Failed to stop: " + (e?.message || String(e)));
        }
    };
    const reset = ()=>{
        setFinalText("");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e2a4e058._.js.map