...
function ListenPage() {
    ...
    const { listening, interim, finalText, error, start, stop, reset } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$stt$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpeechToText"])({
        lang: "en-US",
        continuous: false,
        interimResults: true
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ListenPage.useEffect": ()=>{
            if (!mounted || !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$stt$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sttSupported"]) return;
            if (listening) return;
            const prompt = (finalText + (interim ? " " + interim : "")).trim();
            if (!prompt) return;
            let canceled = false;
            ({
                "ListenPage.useEffect": async ()=>{
                    try {
                        const { text } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["askGemini"])(prompt, {
                            max_tokens: MAX_TOKENS
                        });
                        if (!canceled && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$tts$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supported"]) {
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$tts$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cancel"])();
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    interim && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            opacity: 0.6,
                            whiteSpace: "pre-wrap"
                        },
...
_s(ListenPage, "apheegh+0EELZCGsk2XcEA/E9bU=", false, function() {
    return [
...
//# sourceMappingURL=_66398a96._.js.map