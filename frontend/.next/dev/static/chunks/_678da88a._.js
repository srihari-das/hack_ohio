...
function ListenPage() {
    ...
    const { listening, interim, finalText, error, start, stop, reset } = useSpeechToText({
        lang: "en-US",
        continuous: false,
        interimResults: true
    });
...
_s(ListenPage, "FArtrdwjOQuSNmeE3MPX/9lUoyE=", false, function() {
    return [
        useSpeechToText
    ];
});
...
//# sourceMappingURL=_678da88a._.js.map