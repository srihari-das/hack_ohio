...
(()=>{
    const e = new Error("Cannot find module '../lib/stt'");
...
(()=>{
    const e = new Error("Cannot find module '../lib/tts'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
function ListenPage() {
    ...
    if ($[0] !== "e7c84f83338818bf8153468359adebaf40b320b8a7e77637690c04510e213d35") {
        for(let $i = 0; $i < 43; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e7c84f83338818bf8153468359adebaf40b320b8a7e77637690c04510e213d35";
    }
    ...
    const { listening, interim, finalText, error, start, stop, reset } = useSpeechToText(t2);
    if (!mounted) {
        return null;
    }
    if (!sttSupported) {
...
//# sourceMappingURL=_6d3b01e3._.js.map